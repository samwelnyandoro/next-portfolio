...
<div align="center">
  ...
  <p align="center">
    <img src="https://img.shields.io/github/forks/samwelnyandoro/next-portfolio?style=for-the-badge" />
  <a href="https://samwelnyandoro.vercel.app">
...
1. Fork [this](https://github.com/samwelnyandoro/next-portfolio) repository.
...
1. Update the sample [data.json](https://github.com/samwelnyandoro/next-portfolio/blob/main/data.json) provided, with your data or directly import the same and edit using firebase later. (For storing images you can use [Cloudinary](https://cloudinary.com) or [Firebase Storage](https://firebase.google.com/docs/storage))

2. Import json data

   - Go to [Firebase Console](https://console.firebase.google.com) and select your project
   - Go to "Database" -> "Realtime Database" -> "Import JSON" and import the [data.json](https://github.com/samwelnyandoro/next-portfolio/blob/main/data.json) file
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/samwelnyandoro/next-portfolio/blob/main/LICENSE.md)

<!-- ## Contact 📬

If you want to contact me, you can reach me through below handles.

[![linkedin](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/samwelnyandoro)
